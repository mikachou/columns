...
begin
	...
	begin
		Lin := 1;
		while AMatrice^.Cell_Occupee (Lin, Col) and (Lin <= AMatrice^.Hauteur - ATaDisp) do
		{on parcourt la colonne de bas en haut tant que les cellules sont
		occupées, et tant qu'il y a assez de place au dessus pour former
		un ensemble de ATaDisp joyaux de même couleur}
		begin
...
{----------------------------------------------------------------------}
{cherche les alignements d'au moins ATaDisp joyaux sur la matrice, retourne "vrai"
s'il y a au moins un alignement, "faux" dans le cas contraire}
