...
{----------------------------------------------------------------------}
{renvoie le contenu d'une cellule de la matrice}
...
{----------------------------------------------------------------------}
{renvoie vrai si la cellule est marquée pour disparaitre}
...
{----------------------------------------------------------------------}
{fait disparaitre les cellules : leur assigne une valeur Nul}
