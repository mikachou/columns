...
type
	...
	CPile = object
		...
		public
			constructor Genere (Mat : pCMatrice; TaPile, NbCouleurs : Integer);
...
{----------------------------------------------------------------------}
{génération d'une pile avec trois joyaux aléatoires}
constructor CPile.Genere (Mat : pCMatrice; TaPile, NbCouleurs : Integer);
var
	i : Integer;
	Magic : Boolean;
begin
...
begin
	...
	begin
		...
		{en résumé on assigne à la variable "swap" la couleur du premier joyau,
		la couleur du 1e joyau devient celle du 2e joyau
		--------------2e------------------------3e------
		--------------3e------------------------4e------
		etc...
		la couleur du dernier joyau devient celle de swap (donc celle du 1e joyau)}
	end
end;
{----------------------------------------------------------------------}
...
{----------------------------------------------------------------------}
{renvoie le n-ième joyau de la pile}
...
{----------------------------------------------------------------------}
{renvoie le pointeur de la matrice}
